...
import com.app.wordpress.model.CategoryModel;
import com.app.wordpress.utils.NetUtil;
import com.app.wordpress.utils.Tools;
import com.app.wordpress.utils.Util1;
...
//        if (Util1.isNetworkAvailable(getBaseContext())) {
//            NetUtil.get("get_category_index/", null, new JsonHttpResponseHandler() {
//                @Override
//                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
//                    try {
//                        Util1.saveData(getBaseContext(), "categories", response.toString());
...
//        } else {
//            try {
//                JSONObject response = new JSONObject(Util1.loadData(getBaseContext(), "categories"));
//                JSONArray categories = response.getJSONArray("categories");
//                for (int i = 0; i < categories.length(); i++) {
//                    CategoryModel headeritem = new CategoryModel();
//                    headeritem.fromJson(categories.getJSONObject(i));
